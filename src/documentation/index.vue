...
.documentation.page-container
  ...
  .announcement.w-flex.align-center.mb8
    ...
    w-alert.message-box(border-left color="orange")
      a.orange(
        href="https://blog.vuejs.org/posts/vue-3-as-the-new-default.html"
        target="_blank"
        style="text-decoration: underline") Vue 3 is the new default
      | , and so is Vue Cal 4, for Vue 3. #[span.title2.ml1 🙌]#[br]
      | For Vue 2 projects, you should use #[code npm i vue-cal@#[strong legacy]].
  ...
  w-accordion(:value="[false, true]" :items="2" expand-icon-right expand-single)
